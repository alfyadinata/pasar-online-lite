...
<div id="page-wrapper" style="min-height: 335px;">
    <div class="main-page">
        <div class="tables">
            ...
            <!-- <a data-href="{{ route('cCustomer') }}" class="openPopup btn btn-primary">
                Tambah +
            </a> -->
            <div class="table-responsive bs-example widget-shadow">
                <h4>Data :</h4>
                <form action="{{ route('delManyCustomer') }}" onsubmit="return confirm('Yakin Ingin Menghapus Data Terpilih ?');" method="post">
                    @csrf 
                    @method('delete')
